...
public final class ItemCommentBinding implements ViewBinding {
  ...
  private ItemCommentBinding(@NonNull LinearLayout rootView, @NonNull ImageView commentAvatar,
      @NonNull TextView commentText, @NonNull TextView commentUsername) {
  ...
  public static ItemCommentBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.commentAvatar;
      ImageView commentAvatar = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemCommentBinding((LinearLayout) rootView, commentAvatar, commentText,
          commentUsername);
    }
